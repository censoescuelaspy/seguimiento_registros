...
La vista **Evidencias** combina las cargas nativas de CIALPA Fotos con el archivo histórico conciliado por código RUE. Incluye imágenes y PDF y conserva visibles las escuelas con evidencia aunque todavía no tengan una ficha en la extracción RUE disponible. Las vistas previas se cargan automáticamente desde el backend autenticado cuando entran en pantalla; los originales se solicitan solo al abrirlos. Al abrir un PDF, el tablero presenta una galería diferida de sus páginas con imágenes y permite ampliar cada lámina o abrir el documento completo. Ningún archivo forma parte de la instantánea pública.
